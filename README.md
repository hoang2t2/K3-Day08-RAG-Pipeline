...
```text
 ...
 [ Task 5: Semantic Search ]   [ Task 6: Lexical Search (BM25) ]
  (ChromaDB + BAAI/bge-m3)      (Keyword Map + Rank-BM25)
        │                               │
        └───────────────┬───────────────┘
                        ▼
           [ Task 9: Hybrid Fusion (RRF) ]
                        │
                        ▼
            [ Task 7: Reranking Module ]
                        │
          ...
          Yes│                     │No (Fallback)
             ▼                     ▼
     [ Reranked Context ]   [ Task 8: PageIndex Vectorless ]
             │                     │
             └──────────┬──────────┘
                        ▼
      [ Task 10: Reorder Context (Lost in the Middle) ]
                        │
                        ▼
